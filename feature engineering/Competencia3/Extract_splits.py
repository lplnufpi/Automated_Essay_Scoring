...
if __name__ == '__main__':
    ...
    X_train.to_csv('C3_X_train90.csv', index=False)
    X_test.to_csv('C3_X_test10.csv', index=False)
    y_train.to_csv('C3_y_train90.csv', index=False)
    y_test.to_csv('C3_y_test10.csv', index=False)